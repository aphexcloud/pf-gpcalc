...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center">
      ...
      {/* Floating Orbs for Depth - Subtle Grey */}
      ...
      <div className="relative z-10 w-full max-w-md mx-4 animate-fade-in">
        <div className="glass-card p-8 sm:p-10 backdrop-blur-2xl bg-white/60 border border-white/80 shadow-2xl shadow-gray-900/5 rounded-3xl transform transition-all duration-500 hover:scale-[1.02] hover:shadow-3xl">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1">
              ...
              <input
                ...
                className="glass-input w-full px-4 py-3 bg-white/70 backdrop-blur-xl border border-gray-200/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all duration-300 text-gray-900 placeholder-gray-400 hover:bg-white/80"
            ...
            {error && (
              <div className="glass-alert bg-red-50/80 backdrop-blur-xl border border-red-200/60 text-red-700 text-sm p-4 rounded-xl animate-shake">
        ...
        <div className="absolute inset-x-0 -bottom-20 h-20 bg-gradient-to-t from-gray-100/30 to-transparent blur-xl"></div>
      </div>
      ...
      {showForgotPassword && (
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="glass-modal w-full max-w-md bg-white/70 backdrop-blur-2xl border border-white/80 rounded-3xl p-8 shadow-2xl shadow-gray-900/10 animate-scale-in">
              {/* Modal Header */}
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100/80 hover:bg-gray-200/80 transition-colors duration-200"
                >
              ...
              <form onSubmit={handleForgotPassword} className="space-y-5">
                ...
                {error && (
                  <div className="glass-alert bg-red-50/80 backdrop-blur-xl border border-red-200/60 text-red-700 text-sm p-4 rounded-xl">
                    <div className="flex items-center gap-2">
                      <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
                      </svg>
                ...
                {resetSuccess && (
                  <div className="glass-alert bg-green-50/80 backdrop-blur-xl border border-green-200/60 text-green-700 text-sm p-4 rounded-xl">
                    <div className="flex items-center gap-2">
                      <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-white/70 backdrop-blur-xl border border-gray-200/60 rounded-xl text-gray-700 font-semibold hover:bg-white/90 transition-all duration-300"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 py-3 px-6 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/40 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {resetLoading ? (
                      <span className="flex items-center justify-center gap-2">
      ...
      <style jsx>{`
        ...
        @keyframes glow {
          ...
          50% { box-shadow: 0 10px 40px rgba(59, 130, 246, 0.5); }
        }
